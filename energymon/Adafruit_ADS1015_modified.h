...
/*!
    ...
    v1.2  - Added continuous conversion support -marked with bhc - Bobby Chung
*/
/**************************************************************************/
...
//  bhc added for continuous conversion
  int16_t   readADC_Differential_0_1_cont(uint8_t read_only);
  int16_t   readADC_Differential_2_3_cont(uint8_t read_only);
